...
export default function Login() {
  ...
  const { login, signInWithGoogle } = useAuth(); // UPDATE THIS
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors outline-none rounded-xl"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  ...
                  disabled={googleLoading} // ADD THIS
                  className="w-full flex justify-center items-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors disabled:opacity-50"
                >
                  {googleLoading ? (
